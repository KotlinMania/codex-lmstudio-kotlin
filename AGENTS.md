# Agent guide - codex-lmstudio-kotlin

This file is the quick-reference operating contract for codex-lmstudio-kotlin. The longer
...
codex-lmstudio-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`codex-lmstudio`](./README.md). Upstream Rust is the behavioral oracle while the
