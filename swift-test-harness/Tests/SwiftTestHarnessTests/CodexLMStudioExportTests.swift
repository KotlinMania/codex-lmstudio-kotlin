...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `CodexLMStudio.swiftmodule/`
...
//      `import CodexLMStudio` above would fail at compile time.
//
//   2. The static archive `libCodexLMStudio.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "CodexLMStudio" }` and
//      `flattenPackage = "io.github.kotlinmania.codex.lmstudio"` configuration in
...
//      via the `CodexLMStudioLibrary` product.
//
